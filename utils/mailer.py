...
def _adjuntar(msg, path: str):
    """Adjunta un archivo xlsx al mensaje si existe."""
    import os as _os
...
"""
    ...
    _adjuntar(msg, adjunto_path)    # conciliacion.xlsx
    _adjuntar(msg, adjunto_payway)  # payway_procesado.xlsx
